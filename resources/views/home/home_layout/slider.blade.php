         ...
         <div class="row">
             <div class="col-lg-7 d-flex align-items-center">
                 <div class="lonyo-hero-content" data-aos="fade-up" data-aos-duration="700">
                     <h1 id="slider-title" contenteditable="{{ auth()->check() && auth()->user()->is_admin ? 'true' : 'false' }}" class="hero-title">{{ $slider->title }}</h1>
             ...
             <div class="col-lg-5">
                 <div class="lonyo-hero-thumb" data-aos="fade-left" data-aos-duration="700">
                     <img src="{{ asset('upload/sliders/' . $slider->image) }}" alt="Slider Image">
